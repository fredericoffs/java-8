...
public class FormattingLocalTimeExample {
    ...
    public static void parseTime() {
        ...
        System.out.println("localTime1.parse(time, DateTimeFormatter.ISO_TIME): " + localTime1);
        ...
        System.out.println("localTime2 DateTimeFormatter.ofPattern(\"HH*mm\") : " + localTime2);
    ...
    public static void formatTime() {
        ...
        String time2 = localTime.format(dateTimeFormatter1);
        System.out.println("formattedTime2: " + time2);

        String time3 = dateTimeFormatter1.format(localTime);
        System.out.println("formattedTime3: " + time3);
    }
