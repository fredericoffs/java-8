...
public class LocalDateExample {
    ...
    public static void main(String[] args) {
        ...
        LocalDate localDate1 = LocalDate.of(2018, 3, 3);
        ...
        System.out.println("With Temporal Adjusters nextOrSame: " + localDate.with(TemporalAdjusters.nextOrSame(DayOfWeek.MONDAY)));
        ...
        System.out.println("Minus years ChronoUnit : " + localDate.minus(1, ChronoUnit.DAYS));
